...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Link', fields ['uuid']
        db.create_index(u'jaguar_link', ['uuid'])


    def backwards(self, orm):
        # Removing index on 'Link', fields ['uuid']
        db.delete_index(u'jaguar_link', ['uuid'])
    ...
    models = {
        ...
        u'jaguar.link': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7c4ed2d9-b6ec-42a2-953c-5223737c29c7'", 'max_length': '36', 'db_index': 'True'})
        },
