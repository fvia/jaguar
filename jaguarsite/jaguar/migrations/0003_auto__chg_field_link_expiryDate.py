...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Link.expiryDate'
        db.alter_column(u'jaguar_link', 'expiryDate', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Link.expiryDate'
        db.alter_column(u'jaguar_link', 'expiryDate', self.gf('django.db.models.fields.DateTimeField')())
